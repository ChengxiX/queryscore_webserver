...
(define (after-auth request next) (if (member "admin" (user-club (request-id-cookie request #:name "identity" #:key secret-salt #:shelf-life 86400))) (next request)
