    ...
    (response/xexprh5 (base "社团详情" `((h1 "社团详情") (br) (a ((href ,(embed/url logout))) "登出") (ul ((class "nav nav-tabs") (role "tablist")) (li ((class "nav-item")) (a ((class "nav-link active") (data-toggle "tab") (href "#main")) "总览"))
                                                 ...
                                                 (div ((class "tab-content"))
                                                      (div ((id "main") (class "container tab-pane active")) (br)
                                                           (h2 "总览")
                                                           ,(table-render "社团" "当前积分" club-list (map (lambda (club) (number->string (club-score club))) club-list)))
                                                      ,@(map (lambda (club) `(div ((id ,club) (class "container tab-pane fade")) (h2 ,club) (p ,(string-append "当前积分:" (number->string (club-score club)))) ,(let ((res (log-*-byclub club))) (table-render-4 "社团" "备注" "积分" "记录时间" (first res) (second res) (map number->string (third res)) (fourth res))))) club-list)
                                                      )
                                                 )
                            )))
